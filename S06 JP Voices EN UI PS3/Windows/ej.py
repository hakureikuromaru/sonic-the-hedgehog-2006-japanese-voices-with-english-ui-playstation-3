...
old_letter = "J" # Letter to match at start
new_letter = "E" # Letter to replace with
old_letter_low = "j"
new_letter_low= "e"
...
destination_dir = "sound\voice\" #Directory that the game uses when PS3 locale is set to English
